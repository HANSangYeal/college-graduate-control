...
<script src="resource/js/jquery.effects.core.js"></script>
<style>
*{
	margin: 0;
	padding: 0;
...
body {
	background-image: url("resource/img/winter1.jpg");
...
<body>
	<div id="menu">
		<div class="item daegu1">
			<img src="resource/img/bubble.png" title="" class="circle" /> <a
				href="#" class="icon"></a>
			<h2>register</h2>
			<ul>
		...
		<div class="item daegu4">
			...
			<h2>list</h2>
			<ul>
				<li><a href="listStudent.jsp">student</a></li>
				<li><a href="listProfessor.jsp">professor</a></li>
				<li><a href="listManager.jsp">manager</a></li>
				<li><a href="haksaList.jsp">haksaList</a></li>
			</ul>
		</div>
